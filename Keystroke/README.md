...
It is recommended to use this one with microsecond (us) precision. It records the timestamp of the keystroke events generated by the kernel. The time from the rdtsc method has an error of the order of microseconds.
