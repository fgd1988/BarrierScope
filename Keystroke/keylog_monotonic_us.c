...
int main(int argc, char **argv) {
    const char *dev =
        "/dev/input/by-id/usb-Logitech_USB_Receiver-if01-event-kbd"; // The value of argv[1] can be overwritten.
    const char *out_path = "keylog_evdev_ts_us.csv";                // The value of argv[2] can be overwritten.
